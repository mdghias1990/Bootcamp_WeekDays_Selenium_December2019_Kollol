...
//public static WebDriver driver;
    ...
    public static String browserstack_accesskey = "";
    public static String saucelabs_username = "";
    public static String saucelabs_accesskey = "";

    @Parameters({"useCloudEnv", "cloudEnvName", "os", "os_version", "browserName", "browserVersion", "url"})
    @BeforeMethod
    public static void setUp(@Optional("false") boolean useCloudEnv, @Optional("false") String cloudEnvName,
                      @Optional("OS X") String os, @Optional("10.15.2") String os_version, @Optional("chrome-options") String browserName, @Optional("79")
    ...
    public static WebDriver getLocalDriver(   @Optional("mac")    String OS, String browserName) {
        if (browserName.equalsIgnoreCase("chrome")) {
            if (OS.equalsIgnoreCase("OS X")) {
                System.setProperty("webdriver.chrome.driver", "/Users/mdghiasuddin/Downloads/Bootcamp_WeekDays_Selenium_December2019_Kollol/Generic/BrowserDriver/Mac/chromedriver");

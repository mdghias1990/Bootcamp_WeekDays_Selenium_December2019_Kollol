...
public class HomePage extends WebElementHomePage {
    ...
    public static void textValidation(WebElement element, String actualText) throws NullPointerException {
    ...
    @FindBy(xpath = xPathPractice)
    public static WebElement practiceButton;

    public static WebElement getPracticeButton() {
        return practiceButton;
    }

    public static void clickPracticeButton() {
        getPracticeButton().click();
    }

    @FindBy(xpath = xPathSelectClassBar)
    public static WebElement selectClassBar;
